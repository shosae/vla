...
#include "ros_action_msgs/msg/detail/object_info__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_action_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ObjectInfo__ros_msg_type = ros_action_msgs__msg__ObjectInfo;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_action_msgs
size_t get_serialized_size_ros_action_msgs__msg__ObjectInfo(
  const void * untyped_ros_message,
...
static uint32_t _ObjectInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_action_msgs__msg__ObjectInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_action_msgs
size_t max_serialized_size_ros_action_msgs__msg__ObjectInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_action_msgs__msg__ObjectInfo;
    is_plain =
      (
...
static size_t _ObjectInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_action_msgs__msg__ObjectInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_action_msgs, msg, ObjectInfo)() {
