...
bool ros_action_msgs__msg__object_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_action_msgs.msg._object_info.ObjectInfo", full_classname_dest, 43) == 0);
  }
  ros_action_msgs__msg__ObjectInfo * ros_message = _ros_message;
  {  // object_id
...
PyObject * ros_action_msgs__msg__object_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_action_msgs.msg._object_info");
