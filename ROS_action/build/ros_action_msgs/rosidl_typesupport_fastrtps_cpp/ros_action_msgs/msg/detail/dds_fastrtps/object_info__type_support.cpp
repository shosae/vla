...
#include "ros_action_msgs/msg/detail/object_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_action_msgs::msg::ObjectInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_action_msgs::msg::ObjectInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_action_msgs::msg::ObjectInfo *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ros_action_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<ros_action_msgs::msg::ObjectInfo>()
{
  return &ros_action_msgs::msg::typesupport_fastrtps_cpp::_ObjectInfo__handle;
}
